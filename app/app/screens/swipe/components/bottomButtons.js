  ...
  buttons = {
    ...
    no: (
      <TouchableOpacity onPress={() => this.props.swipeLeft()} style={[styles.button, styles.circle]}>
        <Image source={require('app/app/assets/img/Icon-Delete.png')} style={styles.button}/>
      </TouchableOpacity>
    ),
    yes: (
      <TouchableOpacity onPress={() => this.props.swipeRight()} style={[styles.button, styles.circle]}>
        <Image source={require('app/app/assets/img/Icon-Like.png')} style={styles.button}/>
      </TouchableOpacity>
    ),
    calendar: (
    ...
    info: (
      <TouchableOpacity onPress={() => {
        ...
        <Image source={require('app/app/assets/img/Icon-Details.png')} style={styles.button}/>
      </TouchableOpacity>
    )
  }
  renderNearby(){
